...
DIVES = [
    ...
    #     ('auto') per-league except Cradily (see its note). ===
    # --- GREAT ---
    {
        'species': 'Quagsire',
        'league': 'great',
        'slug': 'shadow-quagsire-great-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/gl_top50_plus_cs.txt',
        'no_thresholds': True,
        'shadow': True,
    ...
    },
    {
        'species': 'Dragonair',
        'league': 'great',
        'slug': 'shadow-dragonair-great-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/gl_top50_plus_cs.txt',
        'no_thresholds': True,
        'shadow': True,
    ...
    },
    {
        'species': 'Cradily',
        'league': 'great',
        'slug': 'cradily-great-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/gl_top50_plus_cs.txt',
        'top_movesets': 1,
        'no_thresholds': True,
        # PvPoke lists two Cradily entries with identical speciesName:
        # 'cradily' (rank #44, ACID build) and 'cradily_b' (rank #132,
        # BULLET_SEED build). species_id('Cradily') resolves to the LAST
        # gamemaster entry (cradily_b), so 'auto' would sim the #132 build.
        # Pin the #44 ACID moveset (stats identical; only moveset differs).
        'extra_args': ['--fast', 'ACID', '--charged', 'GRASS_KNOT,ROCK_TOMB'],
        'reference': 'ACID,GRASS_KNOT,ROCK_TOMB',
    },
    {
        'species': 'Florges',
        'league': 'great',
        'slug': 'florges-great-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/gl_top50_plus_cs.txt',
        'no_thresholds': True,
    },
    {
        'species': 'Lapras',
        'league': 'great',
        'slug': 'shadow-lapras-great-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/gl_top50_plus_cs.txt',
        'no_thresholds': True,
        'shadow': True,
    ...
    },
    {
        'species': 'Dusclops',
        'league': 'great',
        'slug': 'shadow-dusclops-great-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/gl_top50_plus_cs.txt',
        'no_thresholds': True,
        'shadow': True,
    },
    {
        ...
        'league': 'great',
        'slug': 'galarian-moltres-great-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/gl_top50_plus_cs.txt',
        'no_thresholds': True,
    },
    ...
    },
    {
        'species': 'Corviknight',
        'league': 'ultra',
        'slug': 'shadow-corviknight-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
    ...
    },
    {
        'species': 'Empoleon',
        'league': 'ultra',
        'slug': 'shadow-empoleon-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
    ...
    },
    {
        'species': 'Feraligatr',
        'league': 'ultra',
        'slug': 'shadow-feraligatr-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
    },
    {
        ...
        'league': 'ultra',
        'slug': 'alolan-ninetales-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
    },
    {
        'species': 'Forretress',
        'league': 'ultra',
        'slug': 'shadow-forretress-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
    ...
    },
    {
        'species': 'Ninetales (Alolan)',
        'league': 'ultra',
        'slug': 'shadow-alolan-ninetales-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
    ...
    },
    {
        'species': 'Dusknoir',
        'league': 'ultra',
        'slug': 'shadow-dusknoir-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
    },
    {
        'species': 'Lapras',
        'league': 'ultra',
        'slug': 'shadow-lapras-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
    },
    {
        'species': 'Malamar',
        'league': 'ultra',
        'slug': 'shadow-malamar-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
    },
    {
        'species': 'Walrein',
        'league': 'ultra',
        'slug': 'shadow-walrein-ultra-league',
        'html_base': 'index.html',
        'opponents_file': 'opponent_pools/ul_top60.txt',
        'no_thresholds': True,
        'shadow': True,
