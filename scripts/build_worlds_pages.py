...
def provenance_html(meta, manifest):
    ...
    return (
        ...
        'the base form). '
        '<strong>The usage corpus ends 2026-06-06 (Turin)</strong>, at the '
        'June 2026 rebalance boundary (the rebalance data reached PvPoke '
        '2026-06-02, so the final corpus events may straddle it); '
        'model-side ranks are fully post-rebalance. '
