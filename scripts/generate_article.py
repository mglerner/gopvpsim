...
def _render_meta_coverage_per_form_section(cd_move: str, forms: list[dict],
    ...
    intro = (
        ...
        f'<p>See the <a href="../../guides/cd-article/'
        f'#how-to-read-the-shield-scenario-grid">CD Article guide</a> '
        f'for shield asymmetry framing and within-column reading '
        f'advice.</p>'
        f'</details>'
        f'<details class="methodology-details">'
        f'<summary>How the numbers are computed</summary>'
        f'<p><strong>{n_ivs:,} focal IVs &times; '
        f'{pool_phrase}</strong>{sims_phrase} per cell. '
        f'Methodology: <a href="../../guides/how-this-works/">How '
        f'This Works guide</a>.</p>'
        f'</details>'
    )
...
def _render_opp_iv_toggle_control() -> str:
    ...
    return (
        ...
        '<details class="article-opp-iv-help">'
        '<summary>What these dropdowns change</summary>'
        '<p>Rewrites numbers in <strong>Meta Coverage</strong> and '
        '<strong>Matchup Delta</strong>; other sections stay at '
        'PvPoke-default + bait-on. "<em>Rank 1</em>" uses each '
        'opponent\'s highest-stat-product IVs instead of the '
        'PvPoke-default IV spread; "<em>Never</em>" disables '
        'bait-first shielding so the opponent never shields a '
        'bait-move. Unaffected sections (fixed at PvPoke-default + '
        'bait-on): Verdict, Form Comparison, IV Recommendations, '
        'Move Comparison.</p>'
        '</details>'
        '</div>'
    )
...
def _render_meta_coverage_section(cd_move: str, species: str,
    ...
    intro = (
        ...
        f'<details class="methodology-details">'
        f'<summary>How the numbers are computed</summary>'
        f'<p><strong>{n_ivs:,} focal IVs &times; {n_opponents} '
        f'opponents</strong> = {per_cell_sims:,} simulated matchups '
        f'per cell. Methodology: <a href="../../guides/how-this-works/">'
...
def _render_matchup_delta_per_form_section(cd_move: str, forms: list[dict],
    ...
    intro_lines.append(
        ...
        f'matchups</strong> at one (form, opponent) pair. The Opponent '
        f'IVs / Bait toggle above Meta Coverage rewrites these numbers '
        f'to alternate variants (Rank 1 opponents, bait-off shielding, '
        f'etc.); the default view shows PvPoke-default opponent IVs '
        f'with bait on. See the '
        f'<a href="../../guides/how-this-works/">How This Works '
        f'guide</a> for methodology details.</p>'
        f'</details>'
    )
