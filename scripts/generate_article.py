...
def _render_meta_coverage_per_form_section(cd_move: str, forms: list[dict],
    ...
    intro = (
        ...
        f'See the <a href="../../guides/how-this-works/">How This '
        f'Works guide</a> for methodology details.</p>'
        f'</details>'
    )
...
def _render_meta_coverage_section(cd_move: str, species: str,
    ...
    intro = (
        ...
        f'simulated matchups at that shield count. Per-opponent detail '
        f'is in the Matchup Delta table above; see the '
