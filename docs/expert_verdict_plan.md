...
| 3   | Coverage           | For a CMP floor: the line vs rank-1 / PvPoke-default / 10-10-10 / grid median / hundo / 12-12-12 / max opponent build; per row: % of the opponent's grid STRICTLY beaten, tied-spread count, focal clearers | Omitted for non-CMP floors ("mechanism unattributed; no coverage ladder")                                                        |
